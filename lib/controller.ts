...
export class Controller {
    ...
    constructor(restartCallback: () => void, exitCallback: (code: number, restart: boolean) => void) {
        ...
        // Register additional TS1201 IR blaster manufacturer fingerprints not yet in
        // zigbee-herdsman-converters@15.67.1, backported from latest upstream converters.
